<template>
  <section class="msite">
    ...
    <nav class="msite_nav border-1px">
      <div class="swiper-container" v-if="catrgorysArr.length>0">
        <div class="swiper-wrapper">
          <div class="swiper-slide" v-for="(cs,index) in catrgorysArr" :key="index">
...
export default {
  ...
  watch: {
    // 一旦更新立即执行callback
    categorys: function (value, oldValue) {
      this.$nextTick(() => {
